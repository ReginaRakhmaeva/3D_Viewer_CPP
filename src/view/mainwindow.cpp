...
// - Настройка Model виджета для отображения 3D модели через 2D проекцию
...
// 5. Model виджет: отображает 3D модель через 2D проекцию и SceneDrawer
//
// UI ЭЛЕМЕНТЫ:
// - Меню: File (Open, Save, Exit), View (Settings), Help (About)
// - Панель инструментов: кнопки загрузки, трансформации, настроек
// - Центральная область: Model виджет для отображения 3D модели
